...
$fetch_user_blog = mysql_query("Select * from user_blog where admin_approve= '1' order by created desc  ");
$tag_query = '';
			...
			<div class="container">
				<div class="row">
					...
					<div class="main col-sm-8">
						...
						<?php require_once 'blocks/portal_blog.php'; ?>
					...
					<div class="sidebar gray col-sm-4" style="padding-top:0px;">
						...
						<?php require_once 'blocks/widgets/portal_tags.php'; ?>
