	...
	<div id="wrapper">
		...
		<div class="parallax colored-bg pattern-bg" data-stellar-background-ratio="0.5">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h1 class="page-title">Showing Results for <b>'<?php echo $_GET['keyword']; ?>'</b> </h1>
						<?php /* ?>
						<ul class="breadcrumb">
							<li><a href="index.php">Home </a></li>
							<li><a href="#">Properties</a></li>
							<li><a href="properties-list.php">Property Listing</a></li>
						</ul>
						<?php */ ?>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="main col-sm-12">
						...
						<?php require_once 'blocks/search_result_rows.php'; ?>
