						...
						<div id="blog-listing" class="grid-style1 clearfix">
							<div class="row">
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">How to get your dream property for the best price?</a>
										</h3>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">7 tips to get the best mortgage.</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">House, location or price: What's the most important factor?</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
							...
							<div class="row">
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">Selling your home for the best price.</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">So you've decided to rent out your home?</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										...
										<h3>
											<a href="blog-detail.php">On the market: Best deals in New York.</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
							...
							<div class="row">	
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										<ul class="top-info">
											<li><i class="fa fa-calendar"></i> June 13, 2014</li>
											<li><i class="fa fa-comments-o"></i> 3</li>
											<li><i class="fa fa-tags"></i> Investment, Risks, Buying</li>
										</ul>
										<h3>
											<a href="blog-detail.php">Weighing up the risks of buying an investment property.</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										<ul class="top-info">
											<li><i class="fa fa-calendar"></i> June 01, 2014</li>
											<li><i class="fa fa-comments-o"></i> 1</li>
											<li><i class="fa fa-tags"></i> Real Estate, Buyers</li>
										</ul>
										<h3>
											<a href="blog-detail.php">How to attract prospective real estate buyers?</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info-blog">
										<ul class="top-info">
											<li><i class="fa fa-calendar"></i> May 29, 2014</li>
											<li><i class="fa fa-comments-o"></i> 4</li>
											<li><i class="fa fa-tags"></i> Buying, Tips</li>
										</ul>
										<h3>
											<a href="blog-detail.php">Top five legal tips for buying property.</a>
										</h3>
										<p>Sed rutrum urna id tellus euismod gravida. Praesent placerat, mauris ac pellentesque fringilla, tortor libero condimen. Aliquam fermem tum nulla felis, sed molestie libero porttitor in.</p>
									</div>
								</div>
