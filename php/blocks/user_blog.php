						...
						<div class="grid-style1 clearfix">
							...
							<div class="item col-md-12"><!-- Set width to 4 columns for grid view mode only -->
								...
								<div class="image image-large">
									<a href="user_blog_detail.php?id=<?php echo $result['id'] ?>">
								...
								<div class="info-blog">
									<ul class="top-info">
										...
										<li><i class="fa fa fa-times"></i> <a href="blog_delete.php?id=<?php echo $result['id'] ?>">Delete</a> </li>
										<?php if($result['admin_approve']==0){ ?>
										<li><i class="fa fa-clock-o"></i> <a href="#">Pending admin approval </a> </li>
										<?php } ?>
									</ul>
									<h3>
										<a href="user_blog_detail.php?id=<?php echo $result['id'] ?>"><?php echo $result['title']; ?></a>
									</h3>
							...
							<?php } }else {
								...
								<div class="info-blog">
									...
									<h3>
										Sorry No blogs are there .<a href="user_new_blog.php">Click here</a> to write new blog.
									</h3>
									<p></p>
								</div>
							</div>
