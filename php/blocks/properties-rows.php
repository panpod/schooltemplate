						...
						<div id="property-listing" class="list-style clearfix">
							<div class="row">
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">Luxury Apartment with great views</a>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">Stunning Villa with 5 bedrooms</a>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">Recent construction with 3 bedrooms</a>
							...
							<div class="row">
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">Modern construction with parking space</a>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">Single Family Townhouse</a>
								...
								<div class="item col-md-4"><!-- Set width to 4 columns for grid view mode only -->
									...
									<div class="info">
										<h3>
											<a href="properties-detail.php">3 bedroom villa with garage for rent</a>
