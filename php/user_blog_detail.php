...
$fetch_blog_detail = mysql_fetch_assoc((mysql_query("Select * from user_blog where user_id= '".$user_id."' and id = '".mysql_real_escape_string($_GET['id'])."'  ")));
?>
<!DOCTYPE html>
				...
				<div class="row">
					...
					<div class="main col-sm-8">
						...
						<div class="blog-bottom-info">
							...
							<div id="post-author"><a href="edit_blog.php?id=<?php echo mysql_real_escape_string($_GET['id']); ?>"><i class="fa fa-pencil"></i></a> By <?php echo $_SESSION['f_name'].' '.$_SESSION['l_name']; ?></div>
						</div>
