				...
				<div class="row">
					...
					<div class="main col-sm-8">
						...
						<ul class="agency-detail-agents clearfix">
							<li class="col-lg-6">
								<a href="agent-detail.php"><img src="http://placehold.it/307x307" alt="" /></a>
								<div class="info">
									<a href="agent-detail.php"><h3>John Doe</h3></a>
									<span class="location">Manhattan, New York</span>
									<p>Curabitur quis augue magna volutpat velit nec, euismod nibh vestibulum.</p>
									<a href="agent-detail.php">Learn More &raquo;</a>
								</div>
							</li>
							<li class="col-lg-6">
								<a href="agent-detail.php"><img src="http://placehold.it/307x307" alt="" /></a>
								<div class="info">
									<a href="agent-detail.php"><h3>Mary Ipsum Dolor</h3></a>
							...
							<li class="col-lg-6">
								<a href="agent-detail.php"><img src="http://placehold.it/307x307" alt="" /></a>
								<div class="info">
									<a href="agent-detail.php"><h3>George Lorem</h3></a>
